            ...
            <div class="form-box">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-input">
                        ...
                        <input type="text" id="harga" name="harga" value="<?php echo $case['harga']; ?>" required>
                    </div>
                    <div class="form-input">
                    ...
                    <div class="form-input">
                        ...
                        <input type="text" name="bahan" id="bahan" value="<?php echo $case['bahan']; ?>" required>
                    </div>
                    <div class="form-input">
                        <label for="berat">Berat</label>
                        <input type="text" name="berat" id="berat" value="<?php echo $case['berat']; ?>" required>
                    </div>
                    <div class="form-input">
                        <label for="model">Model</label>
                        <input type="text" name="model" id="model" value="<?php echo $case['model']; ?>" required>
                    </div>
                    <div class="form-input">
                        <label for="stok">Deskripsi</label>
                        <textarea type="text" name="deskripsi" id="deskripsi" style="width: 24rem; height: 4rem; border: 1px solid #ccc;" required ><?php echo $case['deskripsi']; ?></textarea>
                    </div>
                    <div class="form-input">
