...
if (isset($_POST['shopping-cart'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    echo "<script>alert('Produk sudah ada di keranjang!'); window.location.href = '../detail/kartunama-detail.php?id=" . $_GET['id'] . "';</script>";
  } else {
    ...
    if (mysqli_stmt_affected_rows($insert_cart) > 0) {
      ...
      echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = '../detail/kartunama-detail.php?id=" . $_GET['id'] . "';</script>";
    }
  }
