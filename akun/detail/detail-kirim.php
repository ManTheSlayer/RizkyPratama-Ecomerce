...
<body>
  <section class="detail-proses">
    <div class="proses-container">
      ...
      $kirim = mysqli_fetch_assoc($result);
      ?>
      <div class="box">
        <div class="judul">
          <h1>Nota Pesanan</h1>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Rp
                <?= number_format($kirim['grand_total']) ?>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="box-price">
        <div class="content">
          ...
          <div class="price">
            ...
            <p>Rp
              <?= number_format($kirim['total_ongkir']) ?>
            </p><br><br>
            <h3 class="total">Rp
        ...
        <div class="button">
          <a href="#" class="bukti" data-bukti="<?= $kirim['bukti'] ?>"><button class="btn-bukti">Cek bukti
              transfer</button></a>
          <a href="../pesanan.php?type=dikirim"><button type="button" class="btn-kembali">Kembali</button></a>
        </div>
      </div>
    </div>
  </section>
