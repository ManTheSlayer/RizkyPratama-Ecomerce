    ...
    <section class="detail-proses">
      <div class="proses-container">
          <?php
            ...
            $tolak = mysqli_fetch_assoc($result);
          ?>
          <div class="box">
            <div class="judul">
              <h1>Nota Pesanan</h1>
            ...
            <div class="tanggal">
              ...
              <p><?= $tolak['tanggal'] ?> WIB</p>
            </div>
          </div>
          <div class="box-alamat">
            <div class="judul">
              <h4>Alamat Pengiriman :</h4>
              <p class="kurir">Kurir : <?= $tolak['ekspedisi'] ?></p>
            </div>
            <div class="alamat">
              <h4 class="penerima"><?= $tolak['namaLengkap'] ?></h4>
              <p><?= $tolak['alamat'] ?></p>
            </div>
          </div>
          <div class="box">
           <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Rp<?= number_format($tolak['grand_total']) ?></td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="box-price">
            ...
            <div class="price">
              <p>Rp<?= number_format($tolak['grand_total']) ?></p>
              <p>Rp<?= number_format($tolak['total_ongkir']) ?></p>
              <h3 class="total">Rp<?= number_format($tolak['final_total']) ?></h3>
            </div>
            </div>
            <div class="button">
              <a href="#" class="bukti" data-bukti="<?= $tolak['bukti'] ?>"><button class="btn-bukti">Cek bukti transfer</button></a>
              <a href="../pesanan.php?type=ditolak"><button type="button" class="btn-kembali">Kembali</button></a>
            </div>
          </div>
      </div>
    </section>
