     ...
     <div class="container-barang">
        <div class="barang">
          <?php
            ...
            $result = mysqli_query($con, "SELECT * FROM pesanan WHERE id_user = '$id_user' AND status_pesanan = 'ditolak' ORDER BY id DESC");
          ...
          <div class="barang-bayar">
            ...
            <div class="total-price">
                <p>Pesanan anda ditolak admin</p>
                <a href="detail/detail-tolak.php?id=<?= $proses["id"]?>"><button class="btn">Detail</button></a>
            </div>
          </div>
          <?php endwhile; 
